...
public class IndirectBoxInteraction : MonoBehaviour, IInteractionObject
{
    ...
    public void Interact(PlayerCharacterController playerController)
    {
        ...
        foreach (Transform child in transform)
        {
            ...
            if (child.TryGetComponent<IndirectBoxInteraction>(out IndirectBoxInteraction doorInteraction))
            {
                if (doorInteraction)
                {
